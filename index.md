...
<section class="home-hero">
  <p class="home-kicker">Журнал о технологиях и ИИ</p>
  <h1>Bookworm</h1>
  <p class="home-lead">Разборы платформ, инженерных практик и продуктовых сдвигов, которые меняют то, как мы строим цифровые сервисы.</p>
</section>
